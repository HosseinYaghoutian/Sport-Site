...
<html lang="en">
  <head>
    ...
    <!-- Google Font -->
    <link
      href=<?php echo get_template_directory_uri()."../../../css.css?family=Roboto:100,300,400,500,700,900&display=swap"?>
      rel="stylesheet"
    />
    <link
      href=<?php echo get_template_directory_uri()."../../../css-1.css?family=Poppins:200,300,400,500,600,700,800,900&display=swap"?>
      rel="stylesheet"
    />
    <!-- Icon Font CSS -->
    ...
    <link
      rel="stylesheet"
      href=<?php echo get_template_directory_uri()."assets/owlcarousel/css/owl.theme.default.min.css"?>
    />
    <!-- Magnific Popup CSS -->
  ...
  <body>
                    ...
                    <div class="col-lg-8 col-10">
                      <div class="banner_content overflow-hidden">
                        ...
                        <a
                          ...
                          href=<?php echo get_template_directory_uri()."shop-left-sidebar.html"?>
                          data-animation="slideInRight"
                  ...
                  >
                    <li class="nav-item">
                      <a
                        ...
                        id="arrival-tab"
                        data-toggle="tab"
                        href=<?php echo get_template_directory_uri()."#arrival"?>
                        role="tab"
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        id="sellers-tab"
                        data-toggle="tab"
                        href=<?php echo get_template_directory_uri()."#sellers"?>
                        role="tab"
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        id="featured-tab"
                        data-toggle="tab"
                        href=<?php echo get_template_directory_uri()."#featured"?>
                        role="tab"
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        id="special-tab"
                        data-toggle="tab"
                        href=<?php echo get_template_directory_uri()."#special"?>
                        role="tab"
                    ...
                    <div class="item">
                      <div class="product">
                        <div class="product_img">
                          <a href=<?php echo get_template_directory_uri()."shop-product-detail.html"?>>
                            <img
                          ...
                          <div class="product_action_box">
                            <ul class="list_none pr_action_btn">
                              ...
                              <li>
                                <a href=<?php echo get_template_directory_uri()."shop-compare.html"?> class="popup-ajax"
                                  ><i class="icon-shuffle"></i
                                ></a>
                              </li>
                              <li>
                                <a
                                  href=<?php echo get_template_directory_uri()."shop-quick-view.html"?>
                                  class="popup-ajax"
                                  ><i class="icon-magnifier-add"></i
                                ></a>
                              </li>
                              <li>
                                <a href=<?php echo get_template_directory_uri()."#"?>?>><i class="icon-heart"></i></a>
                              </li>
                            </ul>
                          </div>
                        </div>
            ...
            <div class="col-md-6">
              <div class="single_banner">
                ...
                <div class="single_banner_info">
                  ...
                  <a href=<?php echo get_template_directory_uri()."shop-left-sidebar.html"?> class="single_bn_link"
                    >Shop Now</a
                  >
                </div>
              </div>
              ...
              >
                    ...
                    <div class="product_img">
                      ...
                      <div class="product_action_box">
                        <ul class="list_none pr_action_btn">
                          ...
                          <li>
                            <a href=<?php echo get_template_directory_uri()."shop-quick-view.html"?> class="popup-ajax"
                              ><i class="icon-magnifier-add"></i
                            ></a>
                          </li>
                          <li>
                ...
                <div class="item">
                  <div class="product">
                    ...
                    <div class="product_info">
                      <h6 class="product_title">
                        <a href=<?php echo get_template_directory_uri()."shop-product-detail.html"?>>light blue Shirt</a>
                      </h6>
                      <div class="product_price">
                        <span class="price">$69.00</span>
                        <del>$89.00</del>
          ...
          <div class="row no-gutters">
            <div class="col-md-4">
              <div class="sale_banner">
                <a class="hover_effect1" href=<?php echo get_template_directory_uri()."#"?>>
                  <img
    ...
    <a href=<?php echo get_template_directory_uri()."#"?> class="scrollup" style="display: none"
